...
public class CustomerRawDAO implements CustomerDAO {
	
	private Datastore datastore;
	private KeyFactory keyFactory;
	
	private static final Logger logger = LoggerFactory.getLogger(CustomerRawDAO.class);
	
	public CustomerRawDAO(Datastore datastore) {
